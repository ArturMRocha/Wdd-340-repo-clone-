...
CREATE TABLE IF NOT EXISTS public.inventory (
    ...
    inv_year CHARACTER(4) NOT NULL,  -- <-- ESTA É A COLUNA QUE FALTAVA!
...
-- 4. CRIAR O RELACIONAMENTO (Chave Estrangeira / FK)
...
-- 6. INSERIR DADOS DA CLASSIFICATION
...
-- Consulta 4: Modificar a descrição do GM Hummer
UPDATE public.inventory 
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior') 
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Consulta 6: Atualizar os caminhos das imagens e miniaturas adicionando "/vehicles"
UPDATE public.inventory 
